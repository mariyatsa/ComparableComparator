...
class TicketTest {
    ...
    Ticket ticket2 = new Ticket("MSK", "BGD", 5500, 10, 6);//4-3
    ...
    public void testCompareTo() {
        ...
        Ticket [] expected = {ticket1,ticket4, ticket6, ticket2, ticket3, ticket5};
    ...
    @Test
       ...
       Comparator<Ticket> comparator = new TicketTimeComparator();
        ...
        Ticket [] expected = {ticket1,ticket4, ticket2, ticket3, ticket6, ticket5};
